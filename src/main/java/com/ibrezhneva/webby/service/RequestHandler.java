...
import com.ibrezhneva.webby.entity.http.HttpResponseConstants;
import com.ibrezhneva.webby.entity.http.HttpStatus;
import com.ibrezhneva.webby.entity.model.AppServletRequest;
import com.ibrezhneva.webby.entity.model.AppServletResponse;
...
import com.ibrezhneva.webby.util.RequestParser;
...
public class RequestHandler implements Runnable {
    ...
    private void handle() {
        ...
        PushbackInputStream inputStream = new PushbackInputStream(httpSocket.getInputStream());
    ...
    private void writeResponseDirectly(OutputStream outputStream, HttpStatus httpStatus, String responseBody) {
        writeResponseDirectly(outputStream, httpStatus, responseBody.getBytes());
    }

...
public class Starter {
    private static final String CONFIGURATION_YAML = "config/configuration.yaml";
    ...
    static ServerConfig getServerConfigFromYaml(String configYamlFile) {
        try (BufferedInputStream inputStream = new BufferedInputStream(new FileInputStream(configYamlFile))) {
